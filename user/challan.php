...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			<h2 style="color: white;"><b>TAMILNADU  POLICE</b></h2>
            ...
            <div class="row mt-5">
                ...
                <form method="" id="signup-form" class="signup-form">
					...
					<div class="form-group mt-5">
                      <label  class="mr-5"><span><h3 class="text-white">Overspeed</h3></span>
                      </label>
                    ...
                    <div class="form-group mt-4">
                      ...
                      <input type="checkbox" class="ctype" name="vname" value="600" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">No Entry</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="800" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Overload</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="500" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">No License</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="700" cname='Challan name' />
                    </div>
