...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			</figure><h><b>TAMILNADU  POLICE</b></h>
			<h1 class="animated fadeInDown delay-07s">WELCOME TO TAMILNADU TRAFFIC CONTROL</h1>
			<ul class="we-create animated fadeInUp delay-1s">
				<li>IF U BREAK THE RULE THEN <b>Punish </b></li>
			</ul>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-7 wow fadeInLeft">
					...
					<div class="contact-info-box phone clearfix">
						...
						<span>7598512950</span>
					</div>
					<div class="contact-info-box email clearfix">
						<h3><i class="fa fa-pencil"></i>email:</h3>
						<span>monishku6@gmail.com</span>
					</div>
